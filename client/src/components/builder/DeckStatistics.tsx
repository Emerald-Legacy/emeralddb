                                ...
                                <Grid size={{ xs: 6 }} component="div">
                                  ...
                                  <Paper elevation={2} sx={{ p: 1 }}>
                                    ...
                                    <Typography variant="h6" gutterBottom align="center">
                                      ...
                                      Dynasty Fate Cost (Avg: {averageDynastyFateCost.toFixed(2)})

                                    </Typography>

                                    <BarChart

                                                    xAxis={[{ scaleType: 'band', data: dynastyFateCost.map((d) => d.cost), hideTooltip: true }]}

                                                    series={[{ data: dynastyFateCost.map((d) => d.count), color: '#1b5e20' }]}
                                ...
                                <Grid size={{ xs: 6 }} component="div">
                                  ...
                                  <Paper elevation={2} sx={{ p: 1 }}>
                                    ...
                                    <Typography variant="h6" gutterBottom align="center">
                                      ...
                                      Conflict Fate Cost (Avg: {averageConflictFateCost.toFixed(2)})

                                    </Typography>

                                    <BarChart

                                                    xAxis={[{ scaleType: 'band', data: conflictFateCost.map((d) => d.cost), hideTooltip: true }]}

                                                    series={[{ data: conflictFateCost.map((d) => d.count), valueFormatter: (value) => `${value}`, color: '#4CAF50' }]}
