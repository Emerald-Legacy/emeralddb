...
export default (): Router => {
  ...
  api.post('/cards/:cardId', authorizedOnly, dataAdminOnly, w(updateCard.handler))
  api.delete('/cards/:cardId', authorizedOnly, dataAdminOnly, w(deleteCard.handler))
  api.post('/cards/:cardId/rename', authorizedOnly, dataAdminOnly, w(renameCard.handler))
  api.put('/cards', authorizedOnly, dataAdminOnly, w(createCard.handler))
  api.get('/packs', w(getAllPacks.handler))
  api.put('/packs', authorizedOnly, dataAdminOnly, w(createPack.handler))
  api.put('/packs/import', authorizedOnly, dataAdminOnly, w(importPack.handler))
  api.put('/packs/rotate/:id', authorizedOnly, dataAdminOnly, w(rotatePack.handler))
  api.get('/packs/export/:id', w(exportPack.handler))
  api.post('/cards-in-packs', authorizedOnly, dataAdminOnly, w(updateCardsInPack.handler))
  api.put('/cards-in-packs', authorizedOnly, dataAdminOnly, w(updateCardInPack.handler))
  api.delete('/cards-in-packs', authorizedOnly, dataAdminOnly, w(deleteCardInPack.handler))
  api.get('/formats', w(getAllFormats.handler))
  api.put('/formats', authorizedOnly, dataAdminOnly, w(insertOrUpdateFormat.handler))
  api.get('/cycles', w(getAllCycles.handler))
  api.put('/cycles', authorizedOnly, dataAdminOnly, w(createCycle.handler))
  api.put('/cycles/rotate/:id', authorizedOnly, dataAdminOnly, w(rotateCycle.handler))
  api.get('/traits', w(getAllTraits.handler))
  api.put('/traits', authorizedOnly, dataAdminOnly, w(updateTrait.handler))
  api.delete('/traits', authorizedOnly, dataAdminOnly, w(deleteTrait.handler))
  ...
  api.put('/rulings', authorizedOnly, rulesAdminOnly, w(createRuling.handler))
  api.post('/rulings/:rulingId', authorizedOnly, rulesAdminOnly, w(updateRuling.handler))
  api.delete('/rulings/:rulingId', authorizedOnly, rulesAdminOnly, w(deleteRuling.handler))
